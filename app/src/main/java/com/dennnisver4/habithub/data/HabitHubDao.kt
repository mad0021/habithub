...
interface HabitHubDao {
    ...
    fun getCompletion(objectiveId: Long, date: String): Flow<ObjectiveCompletion?>
    ...
    @Query("""
        ...
        ORDER BY date ASC
    """)
    fun getMonthlyCompletions(objectiveIds: List<Long>, yearMonth: String): Flow<List<ObjectiveCompletion>>
    ...
    suspend fun deleteCompletionByKey(objectiveId: Long, date: String)
    ...
    @Query("""
        ...
        ORDER BY date ASC
    """)
    fun getMonthlyCompletionCounts(objectiveIds: List<Long>, yearMonth: String): Flow<List<DailyCompletionCount>>
}
